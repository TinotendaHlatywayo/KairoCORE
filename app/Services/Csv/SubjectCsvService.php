    ...
    protected static function templateRows(): array
    {
        ...
        $subjects = $isPrimary
            ? [
                ...
                ['Agriculture, Science and Technology and ICT', 'PR-STI', 'theory'],
                ['Social Sciences', 'PR-SOC', 'theory'],
                ['Physical Education and Arts', 'PR-PEA', 'theory'],
            ]
            : [
                ['MATHEMATICS', 'SEC-MATH', 'theory'],
                ['ENGLISH LANGUAGE', 'SEC-ENG', 'theory'],
                ['SHONA LANGUAGE', 'SEC-SHO', 'theory'],
                ['COMBINED SCIENCE', 'SEC-CSC', 'theory'],
                ['GEOGRAPHY', 'SEC-GEO', 'theory'],
                ['PHYSICS', 'SEC-PHY', 'theory'],
                ['CHEMISTRY', 'SEC-CHE', 'theory'],
                ['BIOLOGY', 'SEC-BIO', 'theory'],
                ['HISTORY', 'SEC-HIS', 'theory'],
                ['PE SPORTS AND MASS DISPLAYS', 'SEC-PE', 'theory'],
