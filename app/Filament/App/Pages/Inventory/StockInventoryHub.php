...
class StockInventoryHub extends Page
{
    ...
    protected static ?string $navigationLabel = 'Stock & Inventory';

    protected static ?string $title = 'Stock & Inventory';

    protected static ?int $navigationSort = 1;

    protected static ?string $slug = 'inventory-stock';
