    ...
    public static function modules(): array
    {
        return [
            ...
            [
                ...
                'description' => __('Fees, billing, payments, expenses, revenue and the school bank accounts.'),
                'tabs' => [
                    ['label' => __('Overview'), 'page' => ExecutiveFinancialDashboard::class, 'group' => __('Dashboard & Analytics')],
                    ['label' => __('Financial Statements'), 'page' => FinancialStatementPage::class, 'group' => __('Dashboard & Analytics')],
