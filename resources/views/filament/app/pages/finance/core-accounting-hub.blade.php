<x-filament-panels::page>
    <div class="space-y-6">
        ...
        <div class="sc-hub-hero">
            ...
            <div class="sc-hub-hero-desc">{{ __('Manage the ledger, journal entries, revenue streams, bank accounts and document templates.') }}</div>
        </div>
            ...
            @forelse ($categoryPages as $tab)
                ...
                >
                    <div class="sc-hub-card-icon">
                        @svg($tab['icon'] ?? 'heroicon-o-calculator', 'h-6 w-6')
                    </div>
                    <div>
