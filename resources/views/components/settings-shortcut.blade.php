@php
    $canManageSettings = \Modules\Admin\Services\PermissionRegistry::checkPermission('administration.manage_settings');
@endphp
@if($canManageSettings)
<a href="{{ \App\Filament\App\Pages\SystemSettingsPage::getUrl() }}" 
